...
('3134567891002', 'Ionescu', 'Maria', '2016-07-10', 2002, '0721000002', 'ionescu.maria@admin.ro', 'Strada Victoriei 2, Cluj-Napoca', 'RO49AAAA1B31007593841001', 'Inspector Resurse Umane', 2, 'admin'),
('3134567891003', 'Vasilescu', 'Andrei', '2017-05-20', 2003, '0721000003', 'vasilescu.andrei@admin.ro', 'Strada Independentei 3, Timisoara', 'RO49AAAA1B31007593841002', 'Inspector Resurse Umane', 3, 'admin'),
...
-- Super Admin
('3134567891006', 'Stoica', 'Cristian', '2014-01-15', 3001, '0721000006', 'stoica.cristian@superadmin.ro', 'Strada Principala 6, Constanta', 'RO49AAAA1B31007593841005', 'Super Administrator', 1, 'super-admin'),

-- Angajați
('4134567892001', 'Marinescu', 'Raluca', '2020-05-15', 4001, '0722000001', 'marinescu.raluca@gmail.com', 'Strada Pacii 10, Bucuresti', 'RO49AAAA1B31007593842000', 'Medic', 1, 'angajat'),
